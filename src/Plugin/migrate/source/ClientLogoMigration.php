...
/**
 * The 'client_logo_migration' source plugin.
 *
 * @MigrateSource(
 *   id = "client_logo_migration",
 *   source_module = "cf_migration"
 * )
 */
class ClientLogoMigration extends SqlBase {
  ...
  public function query() {
    ...
    $query->leftJoin('field_data_field_client_company_logo', 'fbi', 'fbi.entity_id=n.nid');
    $query->leftJoin('file_managed', 'fm', 'fm.fid=fbi.field_client_company_logo_fid');
