...
/**
 * The 'files_migration' source plugin.
 *
 * @MigrateSource(
 *   id = "files_migration",
 ...
 * )
 */
class FilesMigration extends SqlBase {
  ...
  public function query() {
    ...
    $query->leftJoin('field_data_field_blog_image', 'fbi', 'fbi.entity_id=n.nid');
    $query->leftJoin('file_managed', 'fm', 'fm.fid=fbi.field_blog_image_fid');
